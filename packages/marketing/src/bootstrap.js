...
const mount = (el, { onNavigate, defaultHistory }) => {
  const history = defaultHistory || createMemoryHistory(); // if we were given a default history, let's use it. I'm going to assign that to history. Otherwise, if we did not get one, we will default to creating our own memory history.
